...
[![npm version](https://badge.fury.io/js/%40musistudio%2Fccw-cli.svg)](https://www.npmjs.com/package/@arsasatria/ccw-cli)
![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)
![Node Version](https://img.shields.io/node/v/@arsasatria/ccw-cli.svg)
...
- **CLI** (`@arsasatria/ccw-cli`): 提供 `ccr` 命令的命令行工具
- **Server** (`@arsasatria/ccw-server`): 处理 API 路由和转换的核心服务器
- **Shared** (`@arsasatria/ccw-shared`): 共享常量和工具
- **UI** (`@arsasatria/ccw-ui`): Web 管理界面（React + Vite）
