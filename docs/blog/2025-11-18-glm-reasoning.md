...
Therefore, we need to explicitly guide the model to believe reasoning is required. Since ccw functions as a proxy, the only feasible approach is modifying prompts or parameters.
