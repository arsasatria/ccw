...
[
  {
    ...
    "path": "/home/user/.ccw/logs/ccw-20241226143022.log",
    "size": 1024000,
    "lastModified": "2024-12-26T14:30:22.000Z"
  },
  {
    "name": "ccw-20241226143021.log",
    "path": "/home/user/.ccw/logs/ccw-20241226143021.log",
    "size": 980000,
...
```bash
curl "http://localhost:3456/api/logs?file=/home/user/.ccw/logs/ccw-20241226143022.log" \
  -H "x-api-key: your-api-key"
```
...
```bash
curl -X DELETE "http://localhost:3456/api/logs?file=/home/user/.ccw/logs/ccw-20241226143022.log" \
  -H "x-api-key: your-api-key"
```
